...
class person:
    ...
    def reduce_mp(self, cost):
        self.mp -= cost # decreses MagicPoints
    ...
    def get_enemy_stats(self):
        ...
        print(bcolors.BOLD + self.name + '        ' + str(self.hp) + '/' + str(self.maxhp) + '|' + bcolors.FAIL + hp_bar + bcolors.ENDC + 
    ...
    def get_stats(self):
        ...
        print(bcolors.BOLD + self.name + '        ' + str(self.hp) + '/' + str(self.maxhp) + '|' + bcolors.OKGREEN + hp_bar + bcolors.ENDC + 
